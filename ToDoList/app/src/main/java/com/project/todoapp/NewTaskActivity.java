...
import com.project.todoapp.data.TaskUpdateService;
...
public class NewTaskActivity extends AppCompatActivity implements
    ...
    //Data limita selectată, stocată ca marcaj de timp
   ...
   // Faceți clic pe evenimente la data scadenței
    @Override
