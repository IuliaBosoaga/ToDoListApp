...
import com.project.todoapp.reminders.AlarmScheduler;
import com.project.todoapp.views.DatePickerFragment;
...
public class TaskDetailActivity extends AppCompatActivity implements
    ...
    public void setDateSelection(long selectedTimestamp) {
        ...
        if(dueDate < time){
            Toast.makeText(this, "Alarma nu poate fi setata pentru o data din trecut", Toast.LENGTH_SHORT).show();
            return;
        }else {
           new AlarmScheduler().scheduleAlarm(getApplicationContext(), dueDate, taskUri);
            Toast.makeText(this, "Alarma setata ", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            if (getDateSelection() == Long.MAX_VALUE) {
                ...
                mDueDate.setText("Data limita: " + formatted);
            }
